...
**/
		ApplicationContext context = new ClassPathXmlApplicationContext("spring.xml");
						   context = new FileSystemXmlApplicationContext("F:/workspaces/SpringJuly17/Spring01_Setup/src/spring.xml");
		...
		BeanFactory factory = new XmlBeanFactory(new FileSystemResource("F:/workspaces/SpringJuly17/Spring01_Setup/src/spring.xml"));
